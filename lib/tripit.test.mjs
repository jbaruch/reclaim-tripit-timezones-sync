...
describe('segment ISO-datetime boundaries', () => {
  ...
  it('clips same-calendar-date overlap when datetimes truly overlap', () => {
    // BNA→ATL flight arrives 09:00 ET; same morning, an ATL→DEN flight
    // leaves at 14:00 ET — both segments end and start on the same
    // date. Date-only compare misses the overlap; datetime compare
    // catches it and clips the earlier segment.
    const segments = [
      {
