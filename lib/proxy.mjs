 ...
 * `HTTPS_PROXY`. No-op when `ONECLI_URL` is unset — keeps existing behavior
...
export function installProxyDispatcher() {
  ...
  // applied at process start. Node itself already reads NODE_EXTRA_CA_CERTS
  // into the default trust store when the process launches via `onecli run`.
