...
echo "  4. Publish the tile to the Tessl registry so 'tessl install' picks"
echo "     up the new version:"
echo "       (cd .tile && tessl tile publish)"
echo "     Skipping this leaves consumers on the previous registry version"
echo "     even after the GitHub tag exists."
